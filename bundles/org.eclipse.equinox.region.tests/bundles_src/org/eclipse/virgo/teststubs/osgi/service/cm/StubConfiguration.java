...
public final class StubConfiguration implements Configuration {
    ...
    public void delete() throws IOException {
        ensureNotDeleted(); // Replaces AspectJ DeletedConfiguration aspect
    ...
    /**
     * Helper method to check if configuration has been deleted.
     * This replaces the AspectJ DeletedConfiguration aspect functionality.
     * 
     * @throws IllegalStateException if the configuration has been deleted
     */
