...
//		System.out.println(
//				Util.getSymbolicName(requirement.getResource()) + " - " + requirement + " is a substitution package!");
...
//			System.out.println(" -> internal, drop all other providers!");
...
//						System.out.println("     -> drop " + capability);
